...
class ContentCardAdapter(context: Context, cardListData: ArrayList<ContentInfo>?): RecyclerView.Adapter<ContentCardAdapter.ViewHolder>() {
    ...
    //출력할 xml파일 지정
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContentCardAdapter.ViewHolder = ViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.recy_item_content_card, parent, false)
    )
