...
CREATE TABLE users(
	u_email VARCHAR(50) NOT NULL PRIMARY KEY,
...
CREATE TABLE contents_review(
	...
	FOREIGN KEY(cr_u_id) REFERENCES users(u_email)
	);
...
CREATE TABLE interworking(
	...
	i_profile_pwd VARCHAR(20),
	FOREIGN KEY(i_c_id) REFERENCES contents(c_id),
	FOREIGN KEY(i_u_id) REFERENCES users(u_email)
	);
...
INSERT INTO users(u_email, u_passwd, u_name, u_nickname, u_gender, u_age, u_subs, u_information)
...
INSERT INTO watching_log(w_id, w_c_id, w_i_id, w_time)
VALUES(1, 1, 1, '01:10:08');

INSERT INTO jjim(j_id, j_c_id, j_i_id, j_state, j_date)
VALUES(1, 1, 1, FALSE, '2022-01-02');